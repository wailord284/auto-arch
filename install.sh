...
if [ "$ramTotal" -gt "2020000" ]; then
	...
	--prgbox "Enabling profile-sync-daemon" "arch-chroot /mnt systemctl --global enable psd.service" "$HEIGHT" "$WIDTH"
fi
clear
